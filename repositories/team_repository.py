...
def select_all():
    ...
    for result in results:
        ...
        team = Team(result["name"], result["race"], player, result["total_wins"], result["total_loses"], result["total_fouls"], result["id"])
        teams.append(team)
    return teams
...
def update(team):
    ...
    values = [team.name, team.race, team.player.id, team.total_wins, team.total_loses, team.total_fouls, team.id]
    run_sql(sql, values)
